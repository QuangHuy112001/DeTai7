...
// CHECK FRIENDS
$is_already_friends = $frnd_obj->is_already_friends($_SESSION['id'], $user_data->id);
//  IF I AM THE REQUEST SENDER
$check_req_sender = $frnd_obj->am_i_the_req_sender($_SESSION['id'], $user_data->id);
// IF I AM THE REQUEST RECEIVER
$check_req_receiver = $frnd_obj->am_i_the_req_receiver($_SESSION['id'], $user_data->id);
// TOTAL REQUESTS
